...
public class Temperatur {
    ...
    public String getStateDependingOnTemp(String elementName) {
        return Element.getState(elementName, this.tempCelsius);
    }

    public StateOfAgregation getStateDependingOnTempEnum(String elementName) {
        return ElementEnum.getStateOfAgregationOfAnElement(elementName, this.tempCelsius);
    }
